...
const processmanager_1 = require("../approx/processmanager");
const patching_1 = require("../approx/patching");
const diagnostics_1 = require("../approx/diagnostics");
async function analyzeFiles(files, solver) {
    ...
    if (options_1.options.approx || options_1.options.approxLoad) {
        ...
        if (options_1.options.approxLoad) {
        ...
        if (files.length === 0)
            ...
            while (a.pendingFiles.length > 0) {
                ...
                if (options_1.options.modulesOnly) {
                    ...
                    (0, extras_1.preprocessAst)(ast, moduleInfo, globals, globalsHidden);
    ...
    if (!options_1.options.modulesOnly && files.length > 0) {
        ...
        if (logger_1.default.isInfoEnabled()) {
            ...
            if (options_1.options.diagnostics) {
                ...
                logger_1.default.info(`CPU time: ${d.cpuTime}ms, propagation: ${d.totalPropagationTime}ms, listeners: ${d.totalListenerCallTime}ms, fragment merging: ${d.totalFragmentMergeTime}ms` +
                    (options_1.options.alloc && options_1.options.widening ? `, widening: ${d.totalWideningTime}ms` : "") + `, finalization: ${d.finalizationTime}ms`);
                ...
                if ((options_1.options.approx || options_1.options.approxLoad) && options_1.options.diagnostics) {
