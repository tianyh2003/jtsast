...
export declare class FragmentState<RVT extends RepresentativeVar | MergeRepresentativeVar = RepresentativeVar> {
    ...
    readonly callToCalleeVars: Map<Node, Set<ConstraintVar>>;
    ...
    registerCall(n: Node, enclosing: FunctionInfo | ModuleInfo, calleeVar: ConstraintVar | undefined, { native, external, accessor }?: {
        native?: boolean;
        external?: boolean;
        accessor?: boolean;
    }): void;
