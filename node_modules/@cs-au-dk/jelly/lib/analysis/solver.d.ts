...
export default class Solver {
    ...
    addForAllAncestorsConstraint(t: ObjectPropertyVarObj, key: TokenListener.READ_ANCESTORS | TokenListener.WRITE_ANCESTORS, opts: Omit<ListenerKey, "l" | "t">, listener: (ancestor: Token) => void): void;
    ...
    collectPropertyRead(typ: "read" | "call", result: ConstraintVar | undefined, base: ConstraintVar | undefined, pck: PackageObjectToken | undefined, prop: string | undefined, node: Node, enclosing: FunctionInfo | ModuleInfo): void;
