...
class GlobalState {
    ...
    canonicalAncestorVars = new WeakMap;
    canonicalReturnVar = new WeakMap;
    canonicalThisVar = new WeakMap;
    canonicalArgumentsVar = new WeakMap;
    ...
    canonicalizeVar(v) {
        if (v instanceof constraintvars_1.NodeVar)
            ...
            return (0, util_1.getOrSet)(this.canonicalArgumentsVar, v.fun, () => v);
    ...
    reachedFile(tofile, from) {
        ...
        if (this.reachedFiles.has(tofile))
            ...
            if (!packageInfo) {
                ...
                if (!options_1.options.modulesOnly && !options_1.options.approxOnly && options_1.options.printProgress && logger_1.default.isVerboseEnabled())
