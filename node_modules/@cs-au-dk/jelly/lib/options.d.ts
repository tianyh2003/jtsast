...
export declare const COPYRIGHT = "Copyright (C) 2023-2024 Anders M\u00F8ller & Oskar Haarklou Veileborg\n";
export declare const PKG: boolean;
...
export declare function setOptions(opts: OptionValues & Partial<typeof options>): void;
export declare function resolveBaseDir(): void;
export declare function resetOptions(): void;
export declare function setDefaultTrackedModules(globs: Set<string> | undefined): void;
export declare let patternProperties: Set<string> | undefined;
export declare function setPatternProperties(props?: Set<string>): void;
