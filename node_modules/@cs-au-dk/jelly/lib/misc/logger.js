...
const logger = winston_1.default.createLogger({
    ...
    transports: new winston_1.default.transports.Stream({ stream: stdout })
});
...
function logToFile(file) {
    const t = new winston_1.default.transports.File({
        filename: file ?? `${(0, os_1.tmpdir)()}${path_1.sep}jelly-${process.pid}.log`
    });
