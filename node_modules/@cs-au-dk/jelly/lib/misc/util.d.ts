...
export declare function mapArrayAddNoDuplicates<K, V>(k: K, v: V, m: Map<K, Array<V>>, eq: (v1: V, v2: V) => boolean): void;
export declare function mapArraySize<K, V>(m: Map<K, Array<V>>): number;
...
export declare function mapSetToPairArray<K, V>(x: Map<K, Set<V>>): Array<[K, V]>;
export declare function addPairArrayToMapSet<K, V>(from: Array<[K, V]>, to: Map<K, Set<V>>): void;
export declare function pushAll<V>(from: Iterable<V>, to: Array<V>): void;
...
export declare function longestCommonPrefix(a: Array<string>): string;
