...
exports.longestCommonPrefix = exports.mapCallsToFunctions = exports.SourceLocationsToJSON = exports.percent = exports.isArrayIndex = exports.strHash = exports.pushAll = exports.addPairArrayToMapSet = exports.mapSetToPairArray = exports.getMapHybridSetSize = exports.addAllMapHybridSet = exports.addMapHybridSet = exports.deleteMapSetAll = exports.deleteAll = exports.mapArraySize = exports.mapArrayAddNoDuplicates = exports.mapArrayAdd = exports.setAll = exports.addAll = exports.mapMapMapSetAll = exports.mapMapSetAll = exports.mapArrayPushAll = exports.mapSetAddAll = exports.mapMapSize = exports.getOrSet = exports.mapGetArray = exports.mapGetSet = exports.mapGetMap = exports.locationIn = exports.locationContains = exports.locationToStringWithFileAndEnd = exports.locationToStringWithFile = exports.locationToString = exports.nodeToString = exports.ternaryToString = exports.ternaryOr = exports.Ternary = void 0;
...
function mapArrayAddNoDuplicates(k, v, m, eq) {
    let a = m.get(k);
    if (!a) {
        a = [];
        m.set(k, a);
...
exports.mapArrayAddNoDuplicates = mapArrayAddNoDuplicates;
function mapArraySize(m) {
    let n = 0;
    for (const v of m.values())
        n += v.length;
    return n;
}
exports.mapArraySize = mapArraySize;
...
function addPairArrayToMapSet(from, to) {
    for (const [k, v] of from)
