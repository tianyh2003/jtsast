...
import { AccessPathToken, AllocationSiteToken, ArrayToken, FunctionToken, NativeObjectToken, ObjectKind, ObjectToken, PackageObjectToken, Token } from "../analysis/tokens";
...
export declare function newObject(p: NativeFunctionParams): ObjectToken | PackageObjectToken;
export declare function newSpecialObject(kind: ObjectKind, p: NativeFunctionParams): AllocationSiteToken;
export declare function newPackageObject(kind: ObjectKind, p: NativeFunctionParams): PackageObjectToken;
export declare function newArray(p: NativeFunctionParams): ArrayToken;
export declare function addInherits(t: ObjectPropertyVarObj, proto: Expression, p: NativeFunctionParams): void;
