...
exports.ecmascriptModels = {
    ...
    classes: [
        ...
        },
        {
            ...
            invoke: (p) => {
                if ((0, types_1.isNewExpression)(p.path.node))
                    (0, nativehelpers_1.returnToken)((0, nativehelpers_1.newPackageObject)("Date", p), p);
            },
            staticMethods: [
                {
                    name: "now"
        ...
        },
        {
            ...
            invoke: (p) => {
                if ((0, types_1.isNewExpression)(p.path.node)) {
                    const t = (0, nativehelpers_1.newSpecialObject)("Map", p);
                    if (p.path.node.arguments.length > 0)
        ...
        },
        {
            ...
            invoke: (p) => {
                (0, nativehelpers_1.returnToken)(!options_1.options.alloc ? p.op.packageObjectToken :
                    (0, nativehelpers_1.newObject)(p), p);
        ...
        },
        {
            ...
            invoke: (p) => {
                if ((0, types_1.isNewExpression)(p.path.node)) {
                    ...
                    (0, nativehelpers_1.returnToken)((0, nativehelpers_1.newSpecialObject)("Promise", p), p);
                }
            },
            staticMethods: [
                {
        ...
        },
        {
            name: "RegExp",
            invoke: (p) => {
                (0, nativehelpers_1.returnToken)((0, nativehelpers_1.newPackageObject)("RegExp", p), p);
            },
            methods: [
                {
                    name: "exec",
        ...
        },
        {
            ...
            invoke: (p) => {
                if ((0, types_1.isNewExpression)(p.path.node)) {
                    const t = (0, nativehelpers_1.newSpecialObject)("Set", p);
                    if (p.path.node.arguments.length > 0)
        ...
        },
        {
            name: "WeakMap",
            invoke: (p) => {
                const t = (0, nativehelpers_1.newSpecialObject)("WeakMap", p);
                if (p.path.node.arguments.length > 0)
        ...
        },
        {
            ...
            invoke: (p) => {
                if ((0, types_1.isNewExpression)(p.path.node)) {
                    ...
                    (0, nativehelpers_1.returnToken)((0, nativehelpers_1.newSpecialObject)("WeakRef", p), p);
                }
            },
            methods: [
                {
        ...
        },
        {
            ...
            invoke: (p) => {
                if ((0, types_1.isNewExpression)(p.path.node))
                    (0, nativehelpers_1.returnToken)((0, nativehelpers_1.newSpecialObject)("WeakSet", p), p);
            },
            methods: [
                {
                    name: "add"
...
exports.STANDARD_METHODS = new Map(exports.ecmascriptModels.classes.map(c => [
    c.name,
