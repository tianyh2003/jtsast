...
function preprocessAst(ast, module, globals, globalsHidden) {
    let nextNodeID = 0;
    function register(n) {
    ...
    (0, traverse_1.default)(ast, {
        enter(path) {
            ...
            if (module && n.loc.module === undefined && n.loc.native === undefined)
                n.loc.module = module;
            ...
            if (module &&
                ((0, types_1.isIdentifier)(n) || (0, types_1.isJSXIdentifier)(n)) &&
