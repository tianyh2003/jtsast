...
import vulnerabilitydetector_1 from "@cs-au-dk/jelly/lib/patternmatching/vulnerabilitydetector.js";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};

export async function jelly_callgraph_html() {
    let files; 
...
export async function jelly_dataflow_html() {
    let files; 
    files = files_1.expand(input_unit.in_addr);
    const solver_1 = __importDefault(Solver);
    const solver = new solver_1.default();
